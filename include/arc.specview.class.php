 ...
 * ר����ͼ��
 *
 * @version        $Id: arc.specview.class.php 1 18:17 2010��7��7��Z tianya $
...
class SpecView
{
    ...
    function MakeHtml($isremote=0)
    {
        ...
        copy($GLOBALS['cfg_basedir'].$GLOBALS['cfg_special']."/spec_1".$GLOBALS['art_shortname'],$GLOBALS['cfg_basedir'].$GLOBALS['cfg_special']."/index.htm");
        $murl = $GLOBALS['cfg_special']."/index.htm";
        return $murl;
    }
